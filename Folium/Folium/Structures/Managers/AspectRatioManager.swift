...
struct AspectRatioManager {
    ...
    static let durian: AspectRatio = ((9.0 / 14.0, 14.0 / 9.0), (9.0 / 14.0, 14.0 / 9.0))
    ...
    static let lychee: AspectRatio = ((7.0 / 8.0, 8.0 / 7.0), (7.0 / 8.0, 8.0 / 7.0))
    static let mandarine: AspectRatio = ((3.0 / 4.0, 4.0 / 3.0), (3.0 / 4.0, 4.0 / 3.0))
    static let mango: AspectRatio = ((3.0 / 4.0, 4.0 / 3.0), (3.0 / 4.0, 4.0 / 3.0))
    static let plum: AspectRatio = ((3.0 / 4.0, 4.0 / 3.0), (3.0 / 4.0, 4.0 / 3.0))
    ...
    static func aspectRatio(for system: System) -> AspectRatio {
        ...
        case .durian:
            AspectRatioManager.durian
        case .grape:
            AspectRatioManager.grape
        case .kiwi:
            AspectRatioManager.kiwi
        case .lychee:
            AspectRatioManager.lychee
        case .mandarine:
            AspectRatioManager.mandarine
        case .mango:
            AspectRatioManager.mango
        case .plum:
            AspectRatioManager.plum
        case .tomato:

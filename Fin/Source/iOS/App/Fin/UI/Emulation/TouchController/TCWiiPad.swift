...
class TCWiiPad: TCView, UIGestureRecognizerDelegate {
  ...
  override init(frame: CGRect) {
    ...
    registerLongPressGestureRecognizerIfPossible()
  }
  ...
  private func registerLongPressGestureRecognizerIfPossible() {
    guard let realView = self.real_view else {
      return
    }
    ...
    realView.addGestureRecognizer(pressHandler)
  }

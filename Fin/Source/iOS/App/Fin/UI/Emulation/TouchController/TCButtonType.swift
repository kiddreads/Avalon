...
enum TCButtonType: Int
{
  ...
  func glassLabel() -> String {
    switch self {
    case .gcButtonA, .wiiButtonA, .classicButtonA: return "A"
    case .gcButtonB, .wiiButtonB, .classicButtonB: return "B"
    case .gcButtonX, .classicButtonX: return "X"
    case .gcButtonY, .classicButtonY: return "Y"
    case .gcButtonZ: return "Z"
    case .gcButtonStart: return "START"
    case .gcTriggerL, .classicTriggerL: return "L"
    case .gcTriggerR, .classicTriggerR: return "R"
    case .wiiButtonMinus, .classicButtonMINUS: return "−"
    case .wiiButtonPlus, .classicButtonPLUS: return "+"
    case .wiiButtonHome, .classicButtonHOME: return "⌂"
    case .wiiButtonOne: return "1"
    case .wiiButtonTwo: return "2"
    case .nunchukButtonC: return "C"
    case .nunchukButtonZ: return "Z"
    case .classicButtonZL: return "ZL"
    case .classicButtonZR: return "ZR"
    default: return ""
    }
  }

...
- (void)openDocumentPickerWithSoftwareContentTypesAndPickerType:(DOLSoftwareListDocumentPickerType)pickerType {
  NSArray<UTType*>* types = @[
    [UTType exportedTypeWithIdentifier:@"com.example.fin.generic-software"],
    [UTType exportedTypeWithIdentifier:@"com.example.fin.gamecube-software"],
    [UTType exportedTypeWithIdentifier:@"com.example.fin.wii-software"]
  ];

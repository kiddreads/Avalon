...
public:
  ...
  bool DecodeVerticesOnGPU(VertexLoaderBase* loader, const u8* src, int count) override;
...
private:
  u32 m_vertex_offset;
  u32 m_base_vertex;
  size_t m_vertex_buffer_base_offset = 0;  // GPU byte offset of current allocation start in vertex buffer
};
}  // namespace Metal

...
void CPUInfo::Detect()
{
  ...
  bSHA2 = true;
  bCRC32 = true;
  // All Apple Silicon chips (A14+/M1+) support FEAT_AFP (alternate floating-point behavior).
  // Apple doesn't expose this via sysctl, but it is guaranteed on all arm64 Apple Silicon.
  bAFP = true;

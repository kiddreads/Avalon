...
#pragma clang diagnostic pop
  ...
  // Controller rumble: use Game Controller framework (connected GCController) together with
  // Core Haptics. The controller's haptics property provides a CHHapticEngine for the device;
  // Motor wraps it and plays a continuous haptic pattern when the core requests rumble.
  // See: Playing Haptics on Game Controllers (Apple), WWDC 2020/10614.

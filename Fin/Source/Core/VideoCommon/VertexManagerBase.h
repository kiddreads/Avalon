...
public:
  ...
  /// If the backend can decode vertices on GPU, do it and return true; else return false.
  virtual bool DecodeVerticesOnGPU(VertexLoaderBase* loader, const u8* src, int count)
  {
    return false;
  }

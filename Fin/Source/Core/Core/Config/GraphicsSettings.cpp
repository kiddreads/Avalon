...
// Metal Drawable
const Info<bool> GFX_MTL_SCALE_DRAWABLE_WITH_INTERNAL_RES{
    {System::GFX, "Settings", "ScaleDrawableWithInternalRes"}, true};

// Native Video Decode (iOS)
const Info<bool> GFX_USE_NATIVE_VIDEO_DECODE{
    {System::GFX, "Settings", "UseNativeVideoDecode"}, true};

// MetalFX Upscaling
const Info<bool> GFX_MTL_FX_UPSCALING{{System::GFX, "Settings", "MetalFXUpscaling"}, false};
const Info<int> GFX_MTL_FX_OUTPUT_WIDTH{{System::GFX, "Settings", "MetalFXOutputWidth"}, 0};
const Info<int> GFX_MTL_FX_OUTPUT_HEIGHT{{System::GFX, "Settings", "MetalFXOutputHeight"}, 0};
const Info<bool> GFX_MTL_FX_OUTPUT_125X_INTERNAL{
    {System::GFX, "Settings", "MetalFXOutput125xInternal"}, false};
const Info<int> GFX_MTL_FX_INTERNAL_SCALE{{System::GFX, "Settings", "MetalFXInternalScale"}, 50};
const Info<bool> GFX_MTL_GPU_VERTEX_DECODE{{System::GFX, "Settings", "UseGPUVertexDecode"}, true};
...
const Info<float> GFX_CC_HDR_PAPER_WHITE_NITS{{System::GFX, "ColorCorrection", "HDRPaperWhiteNits"},
                                              203.f};
const Info<float> GFX_CC_EXPOSURE{{System::GFX, "ColorCorrection", "Exposure"}, 1.0f};

...
// Metal Drawable
extern const Info<bool> GFX_MTL_SCALE_DRAWABLE_WITH_INTERNAL_RES;

// Native Video Decode (iOS) – hardware decode FMV/cutscenes for smoother playback
extern const Info<bool> GFX_USE_NATIVE_VIDEO_DECODE;

// MetalFX Upscaling
extern const Info<bool> GFX_MTL_FX_UPSCALING;
extern const Info<int> GFX_MTL_FX_OUTPUT_WIDTH;
extern const Info<int> GFX_MTL_FX_OUTPUT_HEIGHT;
extern const Info<bool> GFX_MTL_FX_OUTPUT_125X_INTERNAL;
extern const Info<int> GFX_MTL_FX_INTERNAL_SCALE;
extern const Info<bool> GFX_MTL_GPU_VERTEX_DECODE;
...
static constexpr float GFX_CC_EXPOSURE_MIN = 0.01f;
static constexpr float GFX_CC_EXPOSURE_MAX = 4.0f;
...
extern const Info<float> GFX_CC_EXPOSURE;

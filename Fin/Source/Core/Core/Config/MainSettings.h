...
extern const Info<int> MAIN_CACHED_INTERPRETER_CODE_REGION_SIZE_MB;
...
extern const Info<bool> MAIN_PREFER_SPATIAL_AUDIO;
/// iOS Core Audio output mode: 0 = Mono, 1 = Stereo, 2 = Surround (6ch). Other platforms ignore.
extern const Info<int> MAIN_AUDIO_OUTPUT_MODE;
/// iOS: when true, request 96 kHz output for higher-quality resampling. Other platforms ignore.
extern const Info<bool> MAIN_AUDIO_UPSAMPLING;

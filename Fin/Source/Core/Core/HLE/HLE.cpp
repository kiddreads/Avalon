...
constexpr std::array<Hook, 31> os_patches{{
    ...
    {"sqrtf",                        HLE_Misc::HLE_FastSqrtf,               HookType::Replace, HookFlag::FastMath},
    {"sinf",                         HLE_Misc::HLE_FastSinf,                HookType::Replace, HookFlag::FastMath},
    {"cosf",                         HLE_Misc::HLE_FastCosf,                HookType::Replace, HookFlag::FastMath},
    {"tanf",                         HLE_Misc::HLE_FastTanf,                HookType::Replace, HookFlag::FastMath},
    {"sqrt",                         HLE_Misc::HLE_FastSqrt,                HookType::Replace, HookFlag::FastMath},
    {"sin",                          HLE_Misc::HLE_FastSin,                 HookType::Replace, HookFlag::FastMath},
    {"cos",                          HLE_Misc::HLE_FastCos,                 HookType::Replace, HookFlag::FastMath},
    {"tan",                          HLE_Misc::HLE_FastTan,                 HookType::Replace, HookFlag::FastMath}
}};
// clang-format on
